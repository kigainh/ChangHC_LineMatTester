 ...
 */
public class SerialService extends Service implements com.example.linemattester.SerialListener {
    ...
    private com.example.linemattester.SerialSocket socket;
    private com.example.linemattester.SerialListener listener;
     ...
     * Api
     */
    public void connect(com.example.linemattester.SerialSocket socket) throws IOException {
        socket.connect(this);
        this.socket = socket;
        connected = true;
    }
    ...
    public void attach(com.example.linemattester.SerialListener listener) {
